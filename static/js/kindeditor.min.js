...
KE.g = {
	//define the skin files' path
	skinPath : KE.scriptPath.replace('/js/','/css/'),
	//define the emos pic's path
	emosPath : KE.scriptPath.replace('/js/','/img/')
};
...
KE.plugin.emoticons = {
	click : function(id) {
		var self = this,
			...
			//change the emoticons' path
			path = KE.g.emosPath + 'emoticons/',
	...
	exec : function(id, num) {
		var src = KE.g.emosPath + 'emoticons/' + num + '.gif';
